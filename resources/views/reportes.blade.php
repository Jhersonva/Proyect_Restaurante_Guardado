...
?>
<div class="content py-5 px-3 bg-danger">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class="px-1 py-1 align-middle"></td>
                                    <td class="px-1 py-1 align-middle"></td>
                                    <td class="px-1 py-1 align-middle"></td>
                                    <td class="px-1 py-1 align-middle"></td>
                                    <td class="px-1 py-1 align-middle text-right"></td>
                                </tr>
    ...
    <div>
        ...
        <div class="d-flex w-100 align-items-center">
            <div class="col-2 text-center">
                <img src="" alt="" class="rounded-circle border" style="width: 5em;height: 5em;object-fit:cover;object-position:center center">
            </div>
            <div class="col-8">
