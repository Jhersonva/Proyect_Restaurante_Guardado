                        ...
                        <div id="menu-list">
                            <fieldset>
                                ...
                                <div id="cat-list" class="py-1">
                                        ...
                                        <button class="btn btn-default btn-xs rounded-pill px-2 cat_btn mx-3 col-lg-3 col-md-4 col-sm-6 col-xs-10 bg-danger" type="button">Bebidas</button>
                                        <button class="btn btn-default btn-xs rounded-pill px-2 cat_btn mx-3 col-lg-3 col-md-4 col-sm-6 col-xs-10 bg-danger" type="button">Desayuno</button>
                                        <button class="btn btn-default btn-xs rounded-pill px-2 cat_btn mx-3 col-lg-3 col-md-4 col-sm-6 col-xs-10 bg-danger" type="button">Almuerzo</button>
                                        <button class="btn btn-default btn-xs rounded-pill px-2 cat_btn mx-3 col-lg-3 col-md-4 col-sm-6 col-xs-10 bg-danger" type="button">Postre</button>
                                        <button class="btn btn-default btn-xs rounded-pill px-2 cat_btn mx-3 col-lg-3 col-md-4 col-sm-6 col-xs-10 bg-danger" type="button">Cena</button>
                                ...
                                <div id="item-list" class="py-1 overflow-auto">
                                    <div class="row row-cols-xl-3 row-cols-md-2 row-cols-sm-1 gy-2 gx-2">
                                            ...
                                            <div class="col menu-item">
                                                <button class="btn btn-default btn-block btn-xs rounded-pill px-2 bg-primary" type="button">Coca Cola</button>
                                            </div>
                                            <div class="col menu-item">
                                                <button class="btn btn-default btn-block btn-xs rounded-pill px-2 bg-primary" type="button">Inka Kola</button>
                                            </div>
                                            <div class="col menu-item">
                                                <button class="btn btn-default btn-block btn-xs rounded-pill px-2 bg-primary" type="button">Pepsi</button><br>
                                            </div>
                                            
                                            <div class="col menu-item">
                                                <button class="btn btn-default btn-block btn-xs rounded-pill px-2 bg-primary" type="button">Limonada</button>
                                            </div>
                                            <div class="col menu-item">
                                                <button class="btn btn-default btn-block btn-xs rounded-pill px-2 bg-primary" type="button">Chicha Morada</button>
                                            </div>
                                            <div class="col menu-item">
                                                <button class="btn btn-default btn-block btn-xs rounded-pill px-2 bg-primary" type="button">Maracuya</button>
                                            </div>
                            ...
                            <div class="text-center py-2">
                                <button class="btn btn-indigo bg-danger rounded-pill px-4">Ordenar</button>
                            </div>
                        </div>
                        <div id="order-list" class="bg-gradient-dark p-1">
                            ...
                            <div id="order-items-holder" class="bg-gradient-light mb-3">
                                <div id="order-items-header">
                                    <div class="d-flex w-100 bg-warning">
